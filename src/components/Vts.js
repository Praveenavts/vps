...
const PayslipTemplateVTS = ({ data, handleChange }) => {
...
<p className='comp-para'><span className='com-span'>Company Name:</span> Vetri Technology Solutions</p>
...
<p className='comp-para'><span className='com-span'>Website:</span> www.vetritechnologysolutions.in </p>
...
export default PayslipTemplateVTS;
